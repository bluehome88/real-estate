...
if ( ! function_exists('wp_rem_cs_counters_shortcode') ) {
    ...
    function wp_rem_cs_counters_shortcode($atts, $content = null) {
        global $post, $wp_rem_cs_var_counter_col, $wp_rem_cs_var_icon_color, $wp_rem_cs_var_count_color, $wp_rem_cs_var_content_color, $wp_rem_cs_var_counters_view;
...
if ( ! function_exists('wp_rem_cs_counter_item') ) {
    ...
    function wp_rem_cs_counter_item($atts, $content = null) {
        ...
        if ( isset($wp_rem_cs_var_counters_view) && $wp_rem_cs_var_counters_view == 'default' ) {
            ...
            $wp_rem_cs_var_counter_item .= '<strong class="custom-counter" style="color:' . esc_html($wp_rem_cs_var_count_color) . ' !important" class="count">' . esc_html(($wp_rem_cs_var_count)) . '</strong>';
