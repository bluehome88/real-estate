...
if ( 'on' <> $wp_rem_cs_var_maintenance_footer_switch && get_the_id() == $wp_rem_cs_var_maintinance_mode_page ) {
    ...
    <footer id="footer">
        <?php
        if ( 'on' === $wp_rem_cs_var_footer_widget ) {
            $footer_sidebar_list = '';
            ...
            if ( isset($wp_rem_cs_var_custom_footer_background) && $wp_rem_cs_var_custom_footer_background != '' ) {
                $footer_bg_image = 'style="background:url(' . esc_url($wp_rem_cs_var_custom_footer_background) . ') no-repeat !important;"';
            }
            ?>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a class="back-to-top" href="#"><i class="icon-keyboard_arrow_up bounce"></i><?php echo esc_html(wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_theme_option_back_to_top')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-inner">
            <div class="footer-widget" <?php echo force_balance_tags($footer_bg_image); ?> >
