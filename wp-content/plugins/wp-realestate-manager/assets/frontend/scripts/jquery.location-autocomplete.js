jQuery(document).ready(function (jQuery) {
    ...
    jQuery.fn.cityAutocomplete.transliterate = function (s) {
        ...
        var char_map = {
			...
			'Ãˆ': 'E', 'Ã‰': 'E', 'Ã?': 'E', 'Ã‹': 'E', 'ÃŒ': 'I', 'Ã?': 'I', 'Ã?': 'I', 'Ã?': 'I',
			'Ã?': 'D', 'Ã‘': 'N', 'Ã’': 'O', 'Ã“': 'O', 'Ã”': 'O', 'Ã•': 'O', 'Ã–': 'O', 'Å?': 'O',
			'Ã˜': 'O', 'Ã™': 'U', 'Ã?': 'U', 'Ã›': 'U', 'Ãœ': 'U', 'Å°': 'U', 'Ã?': 'Y', 'Ã?': 'TH',
			'ÃŸ': 'ss',
			...
			'Î™': 'I', 'Î?': 'K', 'Î›': 'L', 'Îœ': 'M', 'Î?': 'N', 'Î?': '3', 'ÎŸ': 'O', 'Î ': 'P',
			'Î¡': 'R', 'Î£': 'S', 'Î?': 'T', 'Î¥': 'Y', 'Î?': 'F', 'Î§': 'X', 'Î¨': 'PS', 'Î©': 'W',
			'Î†': 'A', 'Îˆ': 'E', 'Î?': 'I', 'ÎŒ': 'O', 'Î?': 'Y', 'Î‰': 'H', 'Î?': 'W', 'Îª': 'I',
			'Î«': 'Y',
			...
			'?§': 'Ch', '?¨': 'Sh', '?©': 'Sh', '?ª': '', '?«': 'Y', '?¬': '', '??': 'E', '?®': 'Yu',
            '?¯': 'Ya',
            '?°': 'a', '?±': 'b', '??': 'v', '??': 'g', '?´': 'd', '?µ': 'e', 'Ñ‘': 'yo', '?¶': 'zh',
            '?·': 'z', '?¸': 'i', '??': 'j', '?º': 'k', '?»': 'l', '??': 'm', '??': 'n', '??': 'o',
            '?¿': 'p', 'Ñ€': 'r', 'Ñ?': 's', 'Ñ‚': 't', 'Ñƒ': 'u', 'Ñ„': 'f', 'Ñ…': 'h', 'Ñ†': 'c',
            'Ñ‡': 'ch', 'Ñˆ': 'sh', 'Ñ‰': 'sh', 'Ñ?': '', 'Ñ‹': 'y', 'ÑŒ': '', 'Ñ?': 'e', 'Ñ?': 'yu',
            'Ñ?': 'ya',
            // Ukrainian
            '?„'
                : 'Ye', '?†': 'I', '?‡': 'Yi', 'Ò?': 'G',
                ...
                // Polish
                'Ä„'
                : 'A', 'Ä†': 'C', 'Ä˜': 'e', 'Å?': 'L', 'Åƒ': 'N', 'Ã“': 'o', 'Å?': 'S', 'Å?': 'Z',
                'Å»'
                : 'Z',
                'Ä…'
