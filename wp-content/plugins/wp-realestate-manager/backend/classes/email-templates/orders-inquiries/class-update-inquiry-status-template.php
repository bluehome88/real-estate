...
if ( ! class_exists( 'Wp_rem_inquiry_status_updated_email_template' ) ) {

	class Wp_rem_inquiry_status_updated_email_template {
		...
		public function __construct() {
			...
			$this->email_template_type = 'Inquiry Status Updated';

			$this->email_default_template = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"/></head><body style="margin: 0; padding: 0;"><div style="background-color: #eeeeef; padding: 50px 0;"><table style="max-width: 640px;" binquiry="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e"><h1 style="color: #fff;">Inquiry Status Updated</h1></td></tr><tr><td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"><table binquiry="0" cellpadding="0" cellspacing="0" width="100%"><tr><td width="260" valign="top"><table binquiry="0" cellpadding="0" cellspacing="0" width="100%"><tr><td style="padding-bottom:8px;">Hi, [INQUIRY_USER_NAME]</td></tr><tr><td style="padding-bottom:8px;">Your inquiry is [INQUIRY_STATUS] on "[PROPERTY_TITLE]" property.</td></tr><tr><td>You can see inquiry on following link:</td></tr><tr><td>[INQUIRY_LINK]</td></tr></table></td></tr></table></td></tr><tr><td style="background-color: #ffffff; padding: 30px 30px 30px 30px;"><table binquiry="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="font-family: Arial, sans-serif; font-size: 14px;">&reg; [SITE_NAME], 2016</td></tr></tbody></table></td></tr></tbody></table></div></body></html>';
			...
			$this->email_template_index = 'inquiry-status-updated-template';
			...
			add_action( 'wp_rem_inquiry_status_updated_email', array( $this, 'wp_rem_inquiry_status_updated_email_callback' ), 10, 4 );
		}

		public function wp_rem_inquiry_status_updated_email_callback( $inquiry_id = '' ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_rem_plugin_text_srt( 'wp_rem_update_inquiry' );
				$from = (isset( $template['from'] ) && $template['from'] != '') ? $template['from'] : esc_attr( $this->get_property_user_name() ) . ' <' . $this->get_property_user_email() . '>';
				$recipients = (isset( $template['recipients'] ) && $template['recipients'] != '') ? $template['recipients'] : $this->get_inquiry_user_email();
				...
				Wp_rem_inquiry_status_updated_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_rem_plugin_text_srt( 'wp_rem_update_inquiry_email' ),
				'jh_email_type' => 'html',
			);
	...
	new Wp_rem_inquiry_status_updated_email_template();
}
