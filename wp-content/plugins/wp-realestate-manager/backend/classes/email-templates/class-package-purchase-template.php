...
if ( ! class_exists( 'Wp_rem_package_purchased_email_template' ) ) {

	class Wp_rem_package_purchased_email_template {
		...
		public function __construct() {
			...
			$this->email_template_index = 'package-purchase-template';
			...
			add_action( 'wp_rem_package_purchased_email', array( $this, 'wp_rem_package_purchased_email_callback' ), 10, 2 );
		}

		public function wp_rem_package_purchased_email_callback( $user = '', $package_id = '' ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_rem_plugin_text_srt( 'wp_rem_package_purchased' );
				...
				Wp_rem_package_purchased_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_rem_plugin_text_srt( 'wp_rem_package_purchased_email' ),
				'jh_email_type' => 'html',
			);
	...
	new Wp_rem_package_purchased_email_template();
}
