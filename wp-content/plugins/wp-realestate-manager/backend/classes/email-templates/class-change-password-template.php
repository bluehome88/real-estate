 ...
 * @package	Homevillas
 */
if ( ! class_exists( 'Wp_rem_change_password_email_template' ) ) {

	class Wp_rem_change_password_email_template {
		...
		public function __construct() {
			...
			add_action( 'wp_rem_change_password_email', array( $this, 'change_password_email_callback' ), 10, 2 );
		...
		public function change_password_email_callback( $arg ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				wp_rem_change_password_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_rem_plugin_text_srt( 'wp_rem_new_password_hint' ),
				'jh_email_type' => 'html',
			);
	...
	new wp_rem_change_password_email_template();
}
