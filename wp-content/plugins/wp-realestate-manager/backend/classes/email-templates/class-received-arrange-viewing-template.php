...
if (!class_exists('Wp_rem_received_arrange_viewing_email_template')) {
    ...
    class Wp_rem_received_arrange_viewing_email_template {
        ...
        function get_arrange_viewing_user_name() {
            return isset($this->form_fields['arrange_user_name']) ? $this->form_fields['arrange_user_name'] : '';
        }
        function get_arrange_viewing_user_email() {
            return isset($this->form_fields['arrange_user_email']) ? $this->form_fields['arrange_user_email'] : '';
        }
        function get_arrange_viewing_user_date() {
            return isset($this->form_fields['arrange_view_date']) ? $this->form_fields['arrange_view_date'] : '';
        }
        ...
        function get_arrange_viewing_user_phone() {
            return isset($this->form_fields['arrange_phone_num']) ? $this->form_fields['arrange_phone_num'] : '';
        }
