...
class Wp_rem_Property_Alerts {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script( 'wp-rem-alerts-js', WP_REM_NOTIFICATIONS_PLUGIN_URL . '/assets/js/wp-rem-notifications.js', '', '', true );
                            ...
                            <div class="property-alert-box property-alert property-alert-container-top" >
                                ...
                                <div class="newsletter">
                                    ...
                                    echo '<div class="field-holder">';
                                        ...
                                        $wp_rem_form_fields->wp_rem_form_text_render( $wp_rem_field_opt );
                                    echo '</div>';
                                    ...
                                    <div class="field-holder">
                                        <div class="propertyalert-submit-button input-button-loader">
                                            <input type="button" name="AlertsEmail" class="propertyalert-submit" href="javascript:void(0);" value="<?php echo wp_rem_plugin_text_srt('wp_rem_alerts_submit'); ?>" />
                                        </div>
                                    </div>
                                </div>
