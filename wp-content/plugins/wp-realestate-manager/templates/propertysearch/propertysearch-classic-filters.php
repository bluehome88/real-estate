    ...
    <div class="search-default-fields <?php echo esc_html($property_search_fieled_class); ?>">
        ...
        if ( $propertysearch_advance_filter_switch == 'yes' ) {
            ...
            <div class="field-holder advanced-btn">
                <a href="javascript:void(0);" onclick="wp_rem_advanced_search_field('<?php echo wp_rem_allow_special_char($property_short_counter); ?>');"><?php echo wp_rem_plugin_text_srt('wp_rem_property_search_flter_advanced'); ?></a>
            </div>
        <?php } ?>
        <div class="field-holder search-btn">
            <div class="search-btn-loader-<?php echo wp_rem_allow_special_char($property_short_counter); ?> input-button-loader">
                <button type="submit" class="bgcolor" value="Search"><?php echo wp_rem_plugin_text_srt('wp_rem_property_search_flter_saerch'); ?> <i class="icon-arrow-right3"></i></button>
            </div>
        </div>
    </div>
    <?php
