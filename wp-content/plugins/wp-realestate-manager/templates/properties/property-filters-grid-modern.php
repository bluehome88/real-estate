            ...
            <div class="portfolio grid-fading animated <?php echo esc_html($columns_class); ?>">
                <div class="<?php echo esc_html($main_class); ?> <?php echo esc_html($pro_is_compare); ?>">
                    ...
                    <div class="text-holder">
                        ...
                        <?php } ?>
                        <?php if ( ($wp_rem_property_type_price_switch == 'on' && ($wp_rem_property_price != '' || $wp_rem_property_price_ttd != '')) || $wp_rem_profile_image != '' ) { ?>
                            <div class="price-holder">
                                ...
                                <?php if ( $wp_rem_profile_image != '' ) { ?>
                                    <div class="thumb-img">
                                        <figure>
                                            <a href="<?php echo esc_url(get_permalink($wp_rem_property_member)); ?>"><img src="<?php echo esc_url($wp_rem_profile_image); ?>"></a>
                                        </figure>
                                    </div>
                                <?php } ?>
                            </div>
