...
$wp_rem_property_username = get_post_meta($post_id, 'wp_rem_property_username', true);
...
$team_args = array(
    ...
    'meta_query' => array(
        array(
            'key' => 'wp_rem_company',
            'value' => $wp_rem_property_member_id,
            'compare' => '='
        ),
        array(
            'relation' => 'OR',
                                            ...
                                            <div class="row">
                                                <div class="agent_info_image">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($member_image == '' || FALSE == get_post_status($wp_rem_property_member_id)) {
                                                            $member_image[0] = esc_url(wp_rem::plugin_url() . 'assets/frontend/images/member-no-image.jpg');
                                                        }
