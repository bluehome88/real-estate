...
if ( $member_loop_obj->have_posts() ) {
    $flag = 1;
    ?>
    <div class="member-property <?php echo ($main_class); ?>">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <span class="properties-count">
                                            ...
                                            <span class="member-count-holder">
                                                ...
                                                <span> <?php echo absint($num_of_properties); ?> </span>
                                                <?php echo wp_rem_plugin_text_srt('wp_rem_member_properties2'); ?> 
            ...
            <?php
            $wp_rem_cs_inline_script_memeber = '
            ...
            wp_rem_cs_inline_enqueue_script($wp_rem_cs_inline_script_memeber, 'wp-rem-custom-inline');
            ?>
        </div>
