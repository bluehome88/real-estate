                        ...
                        <div class="user-account-holder">
                            ...
                            <ul class="dashboard-nav">
								...
								if ( true === Wp_rem_Member_Permissions::check_permissions( 'enquiries' ) ) {
									...
									?>
									<li class="user_dashboard_ajax" id="wp_rem_member_enquiries" data-queryvar="dashboard=enquiries"><a href="javascript:void(0);"><i class="icon-contact_mail"></i><?php echo wp_rem_plugin_text_srt('wp_rem_member_dashboard_enquires'); ?></a><b class="label"><?php echo absint( $total_enquiries ); ?></b></li>
								...
								if ( true === Wp_rem_Member_Permissions::check_permissions( 'arrange_viewings' ) ) {
									...
									?>
									<li class="user_dashboard_ajax" id="wp_rem_member_viewings" data-queryvar="dashboard=viewings"><a href="javascript:void(0);"><i class="icon-contact_mail"></i><?php echo wp_rem_plugin_text_srt('wp_rem_member_register_arrange_viewings'); ?></a><b class="label"><?php echo absint( $total_inquiries ); ?></b></li>
									<?php
								}
								...
								<?php } ?>
								<?php if ( $member_profile_type == 'company' && $wp_rem_user_type == 'supper-admin' && $member_user_type != 'buyer' ) {
