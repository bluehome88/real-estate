...
if ( ! class_exists( 'Wp_rem_Locations' ) ) {
	...
	class Wp_rem_Locations {
		...
		public function locations_fields_callback( $tag ) { //check for existing featured ID
			...
			<input type="hidden" value="" name="location-coordinates" id="wp_rem_location_coordinates">
			<input type="hidden" value="" name="location-zoom-level" id="wp_rem_location_zoom_level">
