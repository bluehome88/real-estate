    ...
    class wp_rem_enquire_arrange_button_element {
        ...
        public function wp_rem_send_enquire_arrange_submit_callback() {
            ...
            if (is_user_logged_in()) {
                ...
                $user_message = wp_rem_get_input('wp_rem_user_message', NULL, 'STRING');
...
//					$json['type'] = 'error';
//					$json['msg'] = wp_rem_plugin_text_srt('wp_rem_enquiry_email_not_valid');
//					echo json_encode($json);
//					exit();
//				}
        ...
        public function wp_rem_send_arrange_submit_callback() {
            ...
            $arrange_user_message = wp_rem_get_input('wp_rem_arrange_user_message', NULL, 'STRING');
...
//                $json['type'] = 'error';
//                $json['msg'] = wp_rem_plugin_text_srt('wp_rem_viewing_phone_empty');
//                echo json_encode($json);
//                exit();
//            }
//			if (empty($arrange_user_email)) {
//                $json['type'] = 'error';
//                $json['msg'] = wp_rem_plugin_text_srt('wp_rem_viewing_email_empty');
//                echo json_encode($json);
//                exit();
//            }
//			if ( ! is_email($arrange_user_email) ) {
//				$json['type'] = 'error';
//                $json['msg'] = wp_rem_plugin_text_srt('wp_rem_viewing_email_not_valid');
//                echo json_encode($json);
//                exit();
//			}
        ...
        public function wp_rem_enquire_arrange_buttons_element_html_callback($property_id) {
            ...
            <div class="enquire-holder">
                ...
                ?>
                <a class="enquire-btn<?php echo esc_attr($target_class); ?>" href="javascript:void(0);" data-toggle="modal" data-target="#enquiry-modal"><i class="icon- icon-calendar-check-o"></i><?php echo wp_rem_plugin_text_srt('wp_rem_enquire_arrange_enquiry_now'); ?></a>

                <a class="bgcolor enquire-btn<?php echo esc_attr($target_class); ?>" href="javascript:void(0);" data-toggle="modal" data-target="#arrange-modal"><i class="icon- icon-calendar-check-o"></i><?php echo wp_rem_plugin_text_srt('wp_rem_enquire_arrange_arrange_viewing'); ?></a>
            </div>
            <?php
                                ...
                                <form id="frm_arrange<?php echo absint($wp_rem_property_counter); ?>" class="viewing-request-form" name="form_arrange_view" action="javascript:wp_rem_arrange_view_send_message('<?php echo absint($wp_rem_property_counter); ?>');" method="get">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="field-holder">
                                                <div class="check-box-remind">
                                                    <?php wp_rem_term_condition_form_field('arrange_viewing_term_policy', 'arrange_viewing_term_policy'); ?>
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="field-holder">
                                                <p><?php echo wp_rem_plugin_text_srt('wp_rem_enquire_arrange_viewing_accept_term'); ?> <a href="#"><?php echo wp_rem_plugin_text_srt('wp_rem_enquire_arrange_viewing_accept_term_of_use'); ?></a> <?php echo wp_rem_plugin_text_srt('wp_rem_enquire_arrange_viewing_accept_term_and'); ?> <a href="#"><?php echo wp_rem_plugin_text_srt('wp_rem_enquire_arrange_viewing_privacy_policy'); ?></a></p>
                                            </div>
                                        </div>
                                    </div>
									<?php
