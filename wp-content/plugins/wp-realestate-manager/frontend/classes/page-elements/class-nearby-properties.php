                                                                ...
                                                                <div class="post-category-list resident"><?php
                                                                    if ( strcmp($wp_rem_property_name, '1on1realtor') == 0 ) {
                                                                        ...
                                                                        ?>
                                                                            <div class="member-info">
                                                                                <ul class="list-resident">
                                                                                    <li><i class="icon-user3"></i><a href="<?php echo get_the_permalink($wp_rem_property_member); ?>"><span><?php echo esc_html($wp_rem_team_member_name); ?></span></a></li>
                                                                        ...
                                                                        ?>
                                                                            <div class="member-info">
                                                                                <ul class="list-resident">
                                                                                    <li><i class="icon-user3"></i><a href="<?php echo get_the_permalink($wp_rem_property_member); ?>"><span><?php echo esc_html($wp_rem_property_name); ?></span></a></li>
