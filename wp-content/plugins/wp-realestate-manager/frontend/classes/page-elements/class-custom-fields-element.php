...
if ( ! class_exists('wp_rem_custom_fields_element') ) {
    ...
    class wp_rem_custom_fields_element {
        ...
        public function __construct() {
            ...
            add_filter('wp_rem_custom_fields', array( $this, 'wp_rem_custom_fields_callback' ), 11, 5);
            add_filter('wp_rem_featured_custom_fields', array( $this, 'wp_rem_featured_custom_fields_callback' ), 11, 4);
        }

        public function wp_rem_custom_fields_callback($property_id = '', $custom_fields = array(), $fields_number = '', $field_label = true,$field_icon = true) {
