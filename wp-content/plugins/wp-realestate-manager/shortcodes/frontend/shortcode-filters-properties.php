...
if ( ! class_exists( 'Wp_rem_Shortcode_Properties_with_Filters_Frontend' ) ) {
	...
	class Wp_rem_Shortcode_Properties_with_Filters_Frontend {
		...
		public function wp_rem_properties_filters_content( $property_arg = '' ) {
			...
			?>
			<div class="real-estate-property show-more-property">
				<?php
				...
				<div class="element-title <?php echo ($properties_filters_alagnment); ?>">
						...
						if ( isset( $property_type ) && ! empty( $property_type ) ) {
							...
							foreach ( $property_type as $type_slug ) {
								...
								if ( is_object( $type_obj ) ) {
									?>
									<li class="<?php echo esc_attr( $type_slug ); ?> <?php echo esc_html( $active_tab ); ?>"><span><a data-toggle="tab" href="#<?php echo esc_attr( $type_slug ); ?>"><?php echo wp_rem_plugin_text_srt( 'wp_rem_listfilter_advanced' ); ?> <?php echo esc_html( $type_obj->post_title ); ?></a></span></li>
									<?php
									$active_tab = '';
								}
							}
					...
					<?php if ( $show_more_button == 'yes' && $show_more_button_url != '' ) { ?>
							...
							if ( isset( $property_type ) && ! empty( $property_type ) ) {
								...
								foreach ( $property_type as $type_slug ) {
									if ( is_object( $type_obj ) ) {
										...
										?>
										<div class="tab-pane in <?php echo esc_attr( $active_class ); ?>" id="<?php echo esc_attr( $type_slug ); ?>">
