...
if ( ! class_exists('Wp_rem_Member_Register_User_And_Property') ) {
    ...
    class Wp_rem_Member_Register_User_And_Property {
        ...
        public function wp_rem_register_user_and_add_property_shortcode($atts, $content = "") {
            ...
            $html = $this->render_shortcode_ui(array( 'property_title' => '', 'wp_rem_element_logo' => '', 'property_subtitle' => '', 'property_title_alignment' => '', ), $atts);

            return $html;
        }

        public function render_shortcode_ui($defaults, $atts) {
            global $wp_rem_plugin_options, $property_add_counter, $post;
            ...
            <div class="user-account-holder loader-holder">
                ...
                <div class="element-title align-center ">
                    ...
                    if ( $is_updating === true ) {
                        ?>
                        <h2><?php echo wp_rem_plugin_text_srt('wp_rem_property_update_property') ?></h2>
                        <?php
                    } else {
                        ?>
                        <h2><?php echo wp_rem_plugin_text_srt('wp_rem_property_add_your_property') ?></h2>
                        <?php
                    }
                    if ( $property_subtitle != '' ) {
                        ?>
                        <p><?php echo esc_html($property_subtitle) ?></p>
                        <?php
                    }
                    ?>
                </div>
                <div id="wp-rem-dev-posting-main-<?php echo absint($property_add_counter); ?>" class="user-holder create-property-holder" data-ajax-url="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" data-plugin-url="<?php echo esc_url(wp_rem::plugin_url()); ?>">
                    ...
                    <div id="property-sets-holder" data-doing="<?php echo ($is_updating === true ? 'updating' : 'creating') ?>">
                        ...
                        <form id="wp-rem-dev-property-form-<?php echo absint($property_add_counter); ?>" name="wp-rem-dev-property-form" class="form-fields-set wp-rem-dev-property-form" data-id="<?php echo absint($property_add_counter); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="action" name="action" value="user_and_property_meta_save">
                        </form>
                    ...
                    <script type="text/javascript">
                        jQuery(document).ready(function ($) {
                            add_event_listners({
                                'package_required_error': '<?php wp_rem_plugin_text_srt('wp_rem_property_select_package'); ?>',
                                'processing_request': '<?php wp_rem_plugin_text_srt('wp_rem_property_processing'); ?>',
        ...
        public function property_show_set_settings($die_ret = '') {
            ...
            <li>
                ...
                if ( $is_updating === true ) {
                    ...
                    $update_dash_btn = '<div class="property-update-dashboard"><input type="submit" class="do_updating_btn" value="' . wp_rem_plugin_text_srt('wp_rem_property_update') . '"></div>';
                }
                $html = '
				<div class="row">
								...
								<div class="payment-holder">
									...
									<div class="dashboard-left-btns">
										...
										<div class="next-btn-field">
											<input data-id="' . $property_add_counter . '" type="button" class="next-btn" value="' . wp_rem_plugin_text_srt('wp_rem_property_next') . '" ' . ( is_user_logged_in() ? 'id="btn-next-property-information"' : 'id="btn-next-user-login"' ) . '>
										</div>
									</div>
								</div>
							</div> 
							...
							<div class="field-holder">
								<div class="payment-holder">
									<div class="back-btn-field">
										...
										<input data-id="' . $property_add_counter . '" class="back-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_back') . '" id="btn-back-property-detail" class="back-bg-color">
									</div>
									<div class="dashboard-left-btns">
										' . $back_dash_btn . '
										' . $update_dash_btn . '
										<div class="next-btn-field">
											<input data-id="' . $property_add_counter . '" class="next-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_next') . '" id="btn-next-property-detail" class="bgcolor">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="btns-section">
							<div class="field-holder">
								<div class="payment-holder">
									<div class="back-btn-field">
										<i class="icon-keyboard_arrow_left"></i>
										<input data-id="' . $property_add_counter . '" class="back-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_back') . '" id="btn-back-advance-options" class="back-bg-color">
									</div>
									<div class="dashboard-left-btns">
										' . $back_dash_btn . '
										' . $update_dash_btn . '
										<div class="next-btn-field">
											<input data-id="' . $property_add_counter . '" class="next-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_next') . '" id="btn-next-advance-options" class="bgcolor">
										</div>
									</div>
								</div>
							</div> 
							...
							<div class="btns-section">
								<div class="field-holder">
									<div class="payment-holder">
										<div class="back-btn-field">
											<i class="icon-keyboard_arrow_left"></i>
											<input data-id="' . $property_add_counter . '" class="back-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_back') . '" id="btn-back-loc-address" class="back-bg-color">
										</div>
										<div class="dashboard-left-btns">
											' . $back_dash_btn . '
											' . $update_dash_btn . '
											<div class="next-btn-field">
												<input data-id="' . $property_add_counter . '" class="next-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_next') . '" id="btn-next-loc-address" class="bgcolor">
											</div>
										</div>
									</div>
								</div> 
        ...
        public function property_show_property_photos($die_ret = '') {
            global $property_add_counter, $wp_rem_plugin_options, $wp_rem_form_fields;
						...
						<div class="btns-section">
							<div class="field-holder">
								<div class="payment-holder">
									<div class="back-btn-field">
										<i class="icon-keyboard_arrow_left"></i>
										<input data-id="' . $property_add_counter . '" class="back-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_back') . '" id="btn-back-property-photos" class="back-bg-color">
									</div>
									<div class="dashboard-left-btns">
										' . $back_dash_btn . '
										' . $update_dash_btn . '
										<div class="next-btn-field">
											<input data-id="' . $property_add_counter . '" class="next-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_next') . '" id="btn-next-property-photos" class="bgcolor">
										</div>
									</div>
								</div>
							</div> 
						...
						<div class="btns-section">
							<div class="field-holder">
								<div class="payment-holder">
									<div class="back-btn-field">
										<i class="icon-keyboard_arrow_left"></i>
										<input data-id="' . $property_add_counter . '" class="back-btn" type="button" value="' . wp_rem_plugin_text_srt('wp_rem_property_back') . '" id="btn-back-package" class="back-bg-color">
									</div>
                                                                        ' . wp_rem_term_condition_form_field('term_policy', 'term_policy') . '
									<div class="dashboard-left-btns">
										' . $back_dash_btn . '
										<div class="next-btn-field wp-rem-property-submit-process">
											<div class="wp-rem-property-submit-loader"><input id="register-property-order" class="next-btn" type="submit" value="' . $submit_title . '"></div>
										</div>
									</div>
								</div>
							</div> 
                ...
                <li>
                    <div class="activation-tab-message">
                        <div class="media-holder">
                            <figure>
                                <?php if ( $img_id != '' ) : ?>
                                    <img src="<?php echo wp_get_attachment_url($img_id); ?>" alt="<?php wp_rem_plugin_text_srt('wp_rem_property_thank_you'); ?>">
                                <?php endif; ?>
                            </figure>
                        </div>
                        <div class="text-holder">
                            <strong><?php wp_rem_plugin_text_srt('wp_rem_property_thank_you'); ?></strong>
                        ...
                        <?php if ( $success_phone != '' || $success_fax != '' || $success_email != '' ) : ?>
                            <div class="thankyou-contacts">
                                <p><?php wp_rem_plugin_text_srt('wp_rem_property_for_cancellation'); ?></p>
					...
					<li class="gal-img">
						<div class="drag-list">
							...
							<div class="item-assts">
								...
								<input type="hidden" name="wp_rem_property_gallery_item[]" value="' . $img_item . '">
							</div>
						</div>
					</li>';
                }
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="field-holder">
						...
						<input id="image-uploader-' . $property_add_counter . '" class="wp-rem-dev-gallery-uploader wp_rem_dev_property_gallery_images" style="display:none;" data-id="' . $property_add_counter . '" type="file" multiple="multiple" name="wp_rem_property_gallery_images[]">
					</div>
				</div>
				<script>
				jQuery(document).ready(function ($) {
            ...
            if ( ! is_user_logged_in() ) {
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="field-holder">
						...
						<input type="text" placeholder="' . wp_rem_plugin_text_srt('wp_rem_property_username') . '" data-id="' . $property_add_counter . '" data-type="username" name="wp_rem_property_username" class="wp-rem-dev-username wp-rem-dev-req-field">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="field-holder">
						...
						<input type="text" placeholder="' . wp_rem_plugin_text_srt('wp_rem_property_email_address') . '" data-id="' . $property_add_counter . '" data-type="useremail" name="wp_rem_property_user_email" class="wp-rem-dev-user-email wp-rem-dev-req-field">
        ...
        public function select_property_type($html = '') {
            ...
            if ( $is_updating === true ) {
                $html .= '<input type="hidden" name="wp_rem_property_type" value="' . $selected_type . '">';
                $html .= '<input type="hidden" name="get_property_id" value="' . $get_property_id . '">';
            } else {
                if ( is_array($cust_query) && sizeof($cust_query) > 0 ) {
                    ...
                    foreach ( $cust_query as $post_typ ) {
						...
						<li' . ($post_typ->post_name == $selected_type ? ' class="active"' : '') . '>
							<div class="type-holder-main">
								...
								<label for="property-type-' . $post_typ->ID . '">' . ($typ_imag != '' ? '<img src="' . $typ_imag . '" alt="">' : '') . '<span>' . $post_typ->post_title . '</span></label>
        ...
        public function property_price($select_type = '', $wp_rem_id = 0) {
            global $property_add_counter, $wp_rem_form_fields, $wp_rem_plugin_options;
            $property_type_id = 0;
            $get_property_id = wp_rem_get_input('property_id', 0);
            if ( $get_property_id != '' && $get_property_id != 0 && $this->is_member_property($get_property_id) ) {
                $is_updating = true;
            ...
            if ( is_array($atcive_pkgs) && sizeof($atcive_pkgs) > 0 ) {
                ...
                foreach ( $atcive_pkgs as $atcive_pkg ) {
					...
					<div class="pkg-detail-btn pull-right"> 
						<input type="radio" class="wp-rem-dev-req-field" id="package-' . $package_id . 'pt_' . $atcive_pkg . '" name="wp_rem_property_active_package" value="' . $package_id . 'pt_' . $atcive_pkg . '">
						<a href="javascript:void(0);" class="wp-rem-dev-detail-pkg" data-id="' . $package_id . 'pt_' . $atcive_pkg . '">' . wp_rem_plugin_text_srt('wp_rem_property_detail') . '</a>
						<span class="check-select dev-property-pakcge-step" data-main-id="' . $property_add_counter . '" data-id="' . $package_id . 'pt_' . $atcive_pkg . '" data-ptype="purchased" data-ppric="free"><i class="icon-check-circle-o"></i></span>
					</div>';
                    $pkg_options .= '</div>';
                    ...
                    if ( is_array($all_pkgs_arr) && sizeof($all_pkgs_arr) > 0 ) {
                        ...
                        foreach ( $all_pkgs_arr['package_id'] as $all_pkgs_id ) {
							...
							<td>
								...
								<a href="javascript:void(0)" class="property-pkg-select ' . (is_user_logged_in() ? 'dev-property-pakcge-step' : 'dev-property-pakcge-login-step') . '" data-main-id="' . $property_add_counter . '" data-id="' . $all_pkgs_id . '" data-ptype="buy" data-ppric="' . $package_type . '">' . wp_rem_plugin_text_srt('wp_rem_property_select') . '</a>
						...
						<li class="gal-img">
							<div class="drag-list">
								...
								<div class="item-assts">
									...
									<input type="hidden" name="wp_rem_property_floor_plan_image[]" value="' . $file_attachm . '">
								</div>
							</div>
						</li>';
                    }
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="field-holder">
							...
							<input id="floor-uploader-' . $property_add_counter . '" class="wp-rem-dev-floor-uploader wp_rem_property_floor_images" style="display:none;" type="file" multiple="multiple" name="wp_rem_property_floor_images[]" onchange="wp_rem_handle_floor_file_select(event, \'' . $property_add_counter . '\')">
						</div>
					</div>
					<script>
					jQuery(document).ready(function ($) {
						...
						<li class="gal-img">
							<div class="drag-list">
								...
								<div class="item-assts">
									...
									<input type="hidden" name="wp_rem_property_attachment_file[]" value="' . $file_attachm . '">
								</div>
							</div>
						</li>';
                    }
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="field-holder">
							...
							<input id="attachment-uploader-' . $property_add_counter . '" class="wp-rem-dev-gallery-uploader wp_rem_property_attachment_images" style="display:none;" type="file" multiple="multiple" name="wp_rem_property_attachment_images[]" onchange="wp_rem_handle_attach_file_select(event, \'' . $property_add_counter . '\')">
						</div>
					</div>
					<script>
					jQuery(document).ready(function ($) {
            ...
            if ( $get_property_id != '' && $get_property_id != 0 && $this->is_member_property($get_property_id) ) {
                ...
                $check_box = '
					<div class="checkbox-area">
						...
						<label for="terms-' . $property_add_counter . '">' . wp_rem_plugin_text_srt('wp_rem_property_terms') . '</label>
					</div>';
            }
            $html = '
				<li>
							...
							<div class="btns-section">
								<div class="field-holder">
									<div class="payment-holder">
										' . $check_box . '
										<div class="next-btn-field">
											<input type="submit" class="next-btn" value="' . $btn_text . '">
										</div>
									</div>
								</div>
							</div>
        ...
        public function wp_rem_payment_gateways_package_selected_callback() {
            ...
            if ( $buy_order_action == '1' ) {
                if ( wp_rem_is_package_order($get_trans_id) ) {
                    ...
                    ob_start();
                    $output = wp_rem_payment_process($wp_rem_trans_array);
                    if ( ! empty($output) ) {
        ...
        public function wp_rem_property_add_transaction($type = '', $property_id = 0, $package_id = 0, $member_id = '') {
            ...
            if ( isset($trans_id) && $type != '' && $trans_id > 0 ) {
                ...
                $wp_rem_trans_array = array(
                    ...
                    'transaction_property_serv_num' => isset($t_package_serv_num) ? $t_package_serv_num : '',
                    ...
                    switch ( $cus_type ) {
                        case('text'):
                            ...
                            if ( $cus_meta_key != '' ) {
                                ...
                                $html .= $wp_rem_form_fields->wp_rem_form_text_render($cus_opt_array);
									...
									<ul class="minimum-loading-list">
										<li>
											<div class="spinner-btn input-group spinner">
												...
												' . $wp_rem_form_fields->wp_rem_form_text_render($cus_opt_array) . '
                        ...
                        case('textarea'):
                            ...
                            if ( $cus_meta_key != '' ) {
                                ...
                                $html .= $wp_rem_form_fields->wp_rem_form_textarea_render($cus_opt_array);
                        ...
                        case('dropdown'):
                            ...
                            if ( $cus_meta_key != '' ) {
                                ...
                                if ( isset($cus_field['post_multi']) && $cus_field['post_multi'] == 'yes' ) {
                                    $html .= $wp_rem_form_fields->wp_rem_form_multiselect_render($cus_opt_array);
                                } else {
                                    $html .= $wp_rem_form_fields->wp_rem_form_select_render($cus_opt_array);
                                }
                        ...
                        case('date'):
                            ...
                            if ( $cus_meta_key != '' ) {
                                ...
                                $html .= $wp_rem_form_fields->wp_rem_form_date_render($cus_opt_array);
        ...
        public function subs_package_info($package_id = 0, $trans_id = 0, $in_update = '') {
            ...
            if ( $user_package = $this->get_user_package_trans($package_id, $trans_id) ) {
                ...
                $trans_service_num = get_post_meta($trans_id, 'wp_rem_transaction_property_serv_num', true);
        ...
        public function property_pckage_meta_fields($package_id = '') {
            ...
            $trans_get_value = isset($_package_data['number_of_services']['value']) ? $_package_data['number_of_services']['value'] : '';
            $assign_array[] = array(
                'key' => 'number_of_services',
                'label' => wp_rem_plugin_text_srt('wp_rem_member_add_list_no_of_services'),
                'value' => $trans_get_value,
            );
