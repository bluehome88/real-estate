...
$apiConfig = array(
    ...
    // The application_name is included in the User-Member HTTP header.
    'application_name' => '',
    ...
    // If you want to run the test suite (by running # phpunit AllTests.php in the tests/ wp_rem), fill in the settings below
