...
require_once 'service/apiServiceRequest.php';
  ...
  class AdvertisersServiceResource extends apiServiceResource {
    ...
    /**
     * Retrieves data about all advertisers that the requesting advertiser/member has access to.
     * (advertisers.list)
         * @param string $role The role of the requester. Valid values: 'advertisers' or 'members'.
     * @param string $roleId The ID of the requesting advertiser or member.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
         * @opt_param string relationshipStatus Filters out all advertisers for which do not have the given relationship status with the requesting member.
    ...
    /**
     * Retrieves data about a single advertiser if that the requesting advertiser/member has access
     * to it. Only members can lookup advertisers. Advertisers can request information about
  ...
  class CcOffersServiceResource extends apiServiceResource {
    ...
    /**
     * Retrieves credit card offers for the given member. (ccOffers.list)
         * @param string $member The ID of the member in question.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
     ...
     * @return CcOffers
     */
    public function listCcOffers($member, $optParams = array()) {
  ...
  class EventsServiceResource extends apiServiceResource {
    ...
    /**
     * Retrieves event data for a given advertiser/member. (events.list)
         * @param string $role The role of the requester. Valid values: 'advertisers' or 'members'.
     * @param string $roleId The ID of the requesting advertiser or member.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
     ...
     * @opt_param string advertiserId Caret(^) delimited list of advertiser IDs. Filters out all events that do not reference one of the given advertiser IDs. Only used when under members role. Optional.
     * @opt_param string pageToken The value of 'nextPageToken' from the previous page. Optional.
     ...
     * @opt_param string memberId Caret(^) delimited list of member IDs. Filters out all events that do not reference one of the given members IDs. Only used when under advertiser role. Optional.
     * @return Events
     */
   ...
   *  <code>
   *   $ganService = new apiGanService(...);
   *   $members = $ganService->members;
   *  </code>
   */
  class MembersServiceResource extends apiServiceResource {


    /**
     * Retrieves data about all members that the requesting advertiser/member has access to.
     * (members.list)
         * @param string $role The role of the requester. Valid values: 'advertisers' or 'members'.
     * @param string $roleId The ID of the requesting advertiser or member.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
         * @opt_param string memberCategory Caret(^) delimted list of member categories. Valid categories: (unclassified|community_and_content|shopping_and_promotion|loyalty_and_rewards|network|search_specialist|comparison_shopping|email). Filters out all members not in one of the given advertiser categories. Optional.
     * @opt_param string relationshipStatus Filters out all members for which do not have the given relationship status with the requesting member.
     * @opt_param double minSevenDayEpc Filters out all members that have a seven day EPC average lower than the given value (inclusive). Min value 0.0. Optional.
     * @opt_param double minNinetyDayEpc Filters out all members that have a ninety day EPC average lower than the given value (inclusive). Min value: 0.0. Optional.
     * @opt_param string pageToken The value of 'nextPageToken' from the previous page. Optional.
     * @opt_param string maxResults Max number of items to return in this page. Optional. Defaults to 20.
     * @opt_param int minPayoutRank A value between 1 and 4, where 1 represents the quartile of members with the lowest ranks and 4 represents the quartile of members with the highest ranks. Filters out all members with a lower rank than the given quartile. For example if a 2 was given only members with a payout rank of 25 or higher would be included. Optional.
     * @return Members
     */
    public function listMembers($role, $roleId, $optParams = array()) {
      $params = array('role' => $role, 'roleId' => $roleId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
    ...
    /**
     * Retrieves data about a single advertiser if that the requesting advertiser/member has access
     * to it. Only advertisers can look up members. Members can request information about
     * themselves by omitting the memberId query parameter. (members.get)
         * @param string $role The role of the requester. Valid values: 'advertisers' or 'members'.
     * @param string $roleId The ID of the requesting advertiser or member.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
         * @opt_param string memberId The ID of the member to look up. Optional.
     * @return Member
     */
    public function get($role, $roleId, $optParams = array()) {
      $params = array('role' => $role, 'roleId' => $roleId);
...
class apiGanService extends apiService {
  ...
  public function __construct(apiClient $apiClient) {
    ...
    $this->ccOffers = new CcOffersServiceResource($this, $this->serviceName, 'ccOffers', json_decode('{"methods": {"list": {"parameters": {"advertiser": {"repeated": true, "type": "string", "location": "query"}, "projection": {"enum": ["full", "summary"], "type": "string", "location": "query"}, "member": {"required": true, "type": "string", "location": "path"}}, "id": "gan.ccOffers.list", "httpMethod": "GET", "path": "members/{member}/ccOffers", "response": {"$ref": "CcOffers"}}}}', true));
    $this->events = new EventsServiceResource($this, $this->serviceName, 'events', json_decode('{"methods": {"list": {"parameters": {"orderId": {"type": "string", "location": "query"}, "sku": {"type": "string", "location": "query"}, "eventDateMax": {"type": "string", "location": "query"}, "linkId": {"type": "string", "location": "query"}, "eventDateMin": {"type": "string", "location": "query"}, "memberId": {"type": "string", "location": "query"}, "maxResults": {"format": "uint32", "maximum": "100", "minimum": "0", "location": "query", "type": "integer"}, "advertiserId": {"type": "string", "location": "query"}, "pageToken": {"type": "string", "location": "query"}, "memberId": {"type": "string", "location": "query"}, "status": {"enum": ["active", "canceled"], "type": "string", "location": "query"}, "productCategory": {"type": "string", "location": "query"}, "chargeType": {"enum": ["credit", "debit", "monthly_minimum", "other", "slotting_fee", "tier_bonus"], "type": "string", "location": "query"}, "roleId": {"required": true, "type": "string", "location": "path"}, "role": {"required": true, "enum": ["advertisers", "members"], "location": "path", "type": "string"}, "type": {"enum": ["action", "charge", "transaction"], "type": "string", "location": "query"}}, "id": "gan.events.list", "httpMethod": "GET", "path": "{role}/{roleId}/events", "response": {"$ref": "Events"}}}}', true));
    $this->members = new MembersServiceResource($this, $this->serviceName, 'members', json_decode('{"methods": {"list": {"parameters": {"memberCategory": {"type": "string", "location": "query"}, "relationshipStatus": {"enum": ["approved", "available", "deactivated", "declined", "pending"], "type": "string", "location": "query"}, "minSevenDayEpc": {"format": "double", "type": "number", "location": "query"}, "minNinetyDayEpc": {"format": "double", "type": "number", "location": "query"}, "pageToken": {"type": "string", "location": "query"}, "role": {"required": true, "enum": ["advertisers", "members"], "location": "path", "type": "string"}, "maxResults": {"format": "uint32", "maximum": "100", "minimum": "0", "location": "query", "type": "integer"}, "roleId": {"required": true, "type": "string", "location": "path"}, "minPayoutRank": {"format": "int32", "maximum": "4", "minimum": "1", "location": "query", "type": "integer"}}, "id": "gan.members.list", "httpMethod": "GET", "path": "{role}/{roleId}/members", "response": {"$ref": "Members"}}, "get": {"parameters": {"memberId": {"type": "string", "location": "query"}, "role": {"required": true, "enum": ["advertisers", "members"], "location": "path", "type": "string"}, "roleId": {"required": true, "type": "string", "location": "path"}}, "id": "gan.members.get", "httpMethod": "GET", "path": "{role}/{roleId}/member", "response": {"$ref": "Member"}}}}', true));
  }
}
...
class Event extends apiModel {
  ...
  public $earnings;
  public $chargeType;
  protected $__memberFeeType = 'Money';
  protected $__memberFeeDataType = '';
  public $memberFee;
  ...
  public function setMemberFee(Money $memberFee) {
...
class Member extends apiModel {
  ...
  public function setItem(Member2 $item) {
    $this->item = $item;
  }
  public function getItem() {
    return $this->item;
...
class Members extends apiModel {
  public $nextPageToken;
  protected $__itemsType = 'Member';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(Member) */ $items) {
    $this->assertIsArray($items, 'Member', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
