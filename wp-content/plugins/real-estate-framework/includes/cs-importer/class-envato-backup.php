...
if ( ! class_exists( 'Envato_Backup' ) ) {
  ...
  class Envato_Backup {
    ...
    /**
     * Helper function to sanitize the root wp_rem_cs path.
     *
     * @access    public
     * @since     1.4
     *
    ...
    /**
     * Helper function to sanitize the archive wp_rem_cs path.
     *
     * @access    public
     * @since     1.4
     *
    ...
    public function files() {
      ...
      if ( defined( 'RecursiveRem_csIterator::FOLLOW_SYMLINKS' ) ) {
      
        $filesystem = new RecursiveIteratorIterator( new RecursiveRem_csIterator( $this->root(), RecursiveRem_csIterator::FOLLOW_SYMLINKS ), RecursiveIteratorIterator::SELF_FIRST, RecursiveIteratorIterator::CATCH_GET_CHILD );
     ...
     *
     * Used if RecursiveRem_csIterator::FOLLOW_SYMLINKS isn't available
     *
     * @access    private
     * @since     1.4
     *
    ...
    public function exclude_string( $context = 'zip' ) {
      ...
      foreach( $excludes as $key => &$rule ) {
        ...
        /* Wrap wp_rem_cs fragments and files in wildcards for zip */
